...
if __name__ == '__main__':
    ...
    run('python test_256.py --model test_256 --dataroot ./datasets/mini --name horse2zebra_pretrained --no_dropout --num_test 1 --no_dropout')
    ...
    run('python test_256.py --dataroot ./datasets/facades/ --direction BtoA --model pix2pix --name facades_label2photo_pretrained --num_test 1')

    # cyclegan train/test_256
    ...
    run('python test_256.py --model test_256 --name temp_cyclegan --dataroot ./datasets/mini --num_test 1 --model_suffix "_A" --no_dropout')

    # pix2pix train/test_256
    ...
    run('python test_256.py --model pix2pix --name temp_pix2pix --dataroot ./datasets/mini_pix2pix --num_test 1')

    # template train/test_256
    ...
    run('python test_256.py --model template --name temp2 --dataroot ./datasets/mini_pix2pix --num_test 1')

    # colorization train/test_256 (optional)
    ...
    run('python test_256.py --model colorization --name temp_color --dataroot ./datasets/mini_colorization --num_test 1')
